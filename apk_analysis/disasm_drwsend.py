# disasm_drwsend.py
"""Disassemble cs2p2p_PPPP_DRW_TCPSend to see its encryption path."""
...
print(f"Disassembling cs2p2p_PPPP_DRW_TCPSend at {func_addr:#x}:")
print("=" * 60)
    ...
    if 'bl' in insn.mnemonic:
        for op in insn.operands:
            if op.type == CS_OP_IMM:
                ...
                elif 0x7f450 <= target <= 0x7f600:
                    print(f"  *** CALL to cs2p2p_PPPP_Proto_TCPSend_MSG at {target:#x} ***")
