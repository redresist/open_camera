...
.method public static addDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    .line 335
    :cond_1
    invoke-static {}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m$3()Ljava/lang/Class;
    ...
    invoke-static {v3}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static createShortcutResultIntent(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
    ...
    invoke-static {p0, v0}, Landroidx/core/util/HalfKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;)Landroid/content/Intent;
...
.method public static disableShortcuts(Landroid/content/Context;Ljava/util/List;Ljava/lang/CharSequence;)V
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;
...
.method public static enableShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v2}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/content/pm/ShortcutManager;

    move-result-object v2

    invoke-static {v2, v1}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static getIconMaxHeight(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;)I
...
.method public static getIconMaxWidth(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroidx/core/util/HalfKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)I
...
.method public static getMaxShortcutCountPerActivity(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;)I
...
.method public static pushDynamicShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;)Z
    ...
    invoke-static {v3, v4}, Landroidx/core/util/HalfKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static removeLongLivedShortcuts(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/util/HalfKt$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/content/pm/ShortcutManager;Ljava/util/List;)V
...
.method public static requestPinShortcut(Landroid/content/Context;Landroidx/core/content/pm/ShortcutInfoCompat;Landroid/content/IntentSender;)Z
    ...
    .line 197
    invoke-static {p0, p1, p2}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;)Z
...
.method public static setDynamicShortcuts(Landroid/content/Context;Ljava/util/List;)Z
    ...
    invoke-static {v3, v2}, Landroidx/appcompat/widget/SearchView$$ExternalSyntheticApiModelOutline0;->m(Landroid/content/pm/ShortcutManager;Ljava/util/List;)Z
